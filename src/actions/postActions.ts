...
export const postsLoadedAction = (posts: PostType[]) => ({
  type: POSTS_LOADED,
  payload: posts
});

export const loadPostAction = (post: PostType) => ({
  type: LOAD_POST,
  payload: post
});
...
export const updatePostAction = (post: PostType) => ({
  type: UPDATE_POST,
  payload: post
});
...
export const loadCategoryAction = (category: string) => ({
  type: LOAD_CATEGORY,
  payload: category
});
